...
import FacultyProfile from './pages/faculty-head/FacultyProfile';  // NEW
    ...
    <Router>
      <AppProviders>
            ...
            <Routes>
              ...
              <Route path="/advisor/schedule" element={<ProtectedRoute allowedRoles={['advisor']}><EvaluationSchedule /></ProtectedRoute>} />
              ...
              <Route path="/admin/inquiries" element={<ProtectedRoute allowedRoles={['admin']}><SystemRelatedInquiries /></ProtectedRoute>} />
